...
static const Vtx coin_seg3_vertex_blue[] = {
    {{{   -50,      0,      0}, 0, {   -16,   4080}, {0x00, 0x75, 0xfc, 0xff}}},
    {{{    50,      0,      0}, 0, {  4080,   4080}, {0x00, 0x75, 0xfc, 0xff}}},
    {{{    50,    100,      0}, 0, {  4080,    -16}, {0x00, 0x75, 0xfc, 0xff}}},
    {{{   -50,    100,      0}, 0, {   -16,    -16}, {0x00, 0x75, 0xfc, 0xff}}},
};

// RED
// 0x03005740
static const Vtx coin_seg3_vertex_red[] = {
    {{{   -35,      0,      0}, 0, {   -16,   4080}, {0x52, 0xcc, 0x85, 0xff}}},
    {{{    35,      0,      0}, 0, {  4080,   4080}, {0x52, 0xcc, 0x85, 0xff}}},
    {{{    35,     70,      0}, 0, {  4080,    -16}, {0x52, 0xcc, 0x85, 0xff}}},
    {{{   -35,     70,      0}, 0, {   -16,    -16}, {0x52, 0xcc, 0x85, 0xff}}},
};
