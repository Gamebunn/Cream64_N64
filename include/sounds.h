...
#define SOUND_MARIO_JEEZUS                       /* 0x24228080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x42, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_MARIO_HERE_WE_GO_KLONOA            /* 0x240C8080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x43, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
