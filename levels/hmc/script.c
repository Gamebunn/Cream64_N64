...
const LevelScript level_hmc_entry[] = {
    ...
    AREA(/*index*/ 1, hmc_geo_000B90),
        ...
        OBJECT_WITH_ACTS(/*model*/ MODEL_BLAZE, /*pos*/ -7526,  2241, 6835, /*angle*/ 0, 10, 0, /*behParam*/ 0x00000000, /*beh*/ bhvToadMessageBlaze, /*acts*/ ACT_1 | ACT_2 | ACT_3),
        OBJECT_WITH_ACTS(/*model*/ MODEL_MARINE, /*pos*/ -4653,  -4505, -2997, /*angle*/ 0, 10, 0, /*behParam*/ 0x00000000, /*beh*/ bhvToadMessageMarine2, /*acts*/ ACT_1 | ACT_2 | ACT_3),
