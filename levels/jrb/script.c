...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_LAYLA,             /*pos*/ -1956,  1331,  6500, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBobombBuddyOpensCannon, /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    RETURN(),
};
