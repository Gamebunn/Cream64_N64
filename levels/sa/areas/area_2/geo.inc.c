...
const GeoLayout sa_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, sa_dl_City_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, sa_dl_City_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, sa_dl_City_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, sa_dl_City_mesh_layer_5),
