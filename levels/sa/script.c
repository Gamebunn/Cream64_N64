...
const LevelScript level_sa_entry[] = {
	...
	AREA(2, sa_area_2),
		...
		OBJECT(MODEL_KZ_NEKOARC, -764, 131, -2225, 0, -180, 0, KZNEKO << 16, bhvKZNekoarc),
		...
		OBJECT(MODEL_GREMLIN, -5944, 638, 881, 0, -90, 0, 0x00000000, bhvGremlin),
		OBJECT(MODEL_GREMLIN, -5944, 638, -1595, 0, -90, 0, 0x00000000, bhvGremlin),
